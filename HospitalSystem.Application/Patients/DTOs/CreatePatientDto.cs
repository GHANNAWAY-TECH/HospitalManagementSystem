...
public class CreatePatientDto
{
    ...
    [RegularExpression(@"^[a-zA-Z\s\-']+$", ErrorMessage = "First name only contain letters, spaces, hyphens, and apostrophes")]
    ...
    [RegularExpression(@"^\d{7,10}$", ErrorMessage = "Invalid Identification Number format")]
    ...
    [RegularExpression(@"^(?:254|\+254|0)?(7|1)\d{8}$", ErrorMessage = "Invalid Phone number")]
